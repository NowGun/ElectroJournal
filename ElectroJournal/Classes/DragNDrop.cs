...
namespace ElectroJournal.Classes
{
    internal class DragNDrop
    {
        public static readonly DependencyProperty DropDataFormatProperty
               = DependencyProperty.RegisterAttached("DropDataFormat", typeof(string), typeof(DragNDrop), new FrameworkPropertyMetadata("Text"));
        ...
        public static readonly DependencyProperty DragSourceProperty
            = DependencyProperty.RegisterAttached("DragSource", typeof(DependencyProperty), typeof(DragNDrop), new FrameworkPropertyMetadata(null));
        ...
        public static readonly DependencyProperty DropTargetProperty
           = DependencyProperty.RegisterAttached("DropTarget", typeof(DependencyProperty), typeof(DragNDrop), new FrameworkPropertyMetadata(null));
        ...
        public static readonly DependencyProperty DragAndDropEnabledProperty
            = DependencyProperty.RegisterAttached("DragAndDropEnabled", typeof(bool), typeof(DragNDrop), new FrameworkPropertyMetadata(OnDragAndDropEnableChanged));
