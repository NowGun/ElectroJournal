...
{
    public partial class electrojournalContext : DbContext
    {
        public electrojournalContext()
        {
        }

        public electrojournalContext(DbContextOptions<electrojournalContext> options)
            : base(options)
        {
        }

        public virtual DbSet<Bugreporter> Bugreporters { get; set; } = null!;
        public virtual DbSet<Chapter> Chapters { get; set; } = null!;
        public virtual DbSet<Educational> Educationals { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseMySql("server=193.33.230.80;user id=Zhirov;password=64580082;database=electrojournal", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.29-mysql"));
            }
        }
